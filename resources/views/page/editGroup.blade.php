    ...
    @endif
        ...
        <div class="bg-white p-8 rounded-lg shadow-xl w-11/15 relative">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="total_Student" value="{{ old('total_Student', $group->total_Student) }}" required 
                        id="editClassNameInput" class="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-purple-600"
                        placeholder="###">
                        
                </div>
                <div class="flex justify-end gap-2 pt-4 mt-6 border-t border-gray-200">
                    <button min="0" required id="saveEditClassButton"                
